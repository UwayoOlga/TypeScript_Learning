...
// Note: we’re still returning Person[], but since we've defined overloads, TypeScript will narrow it properly at the call site.
function getObjectKeys<T extends object>(obj: T): (keyof T)[] {
  return Object.keys(obj) as (keyof T)[];
}
//This improves type inference — you no longer need to cast Object.keys() manually.
